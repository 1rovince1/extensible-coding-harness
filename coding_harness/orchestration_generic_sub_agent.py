...
# edges
sub_agent_orchestration.add_edge(START, "context_compressor")
sub_agent_orchestration.add_edge("context_compressor", "generic_sub_agent")
sub_agent_orchestration.add_conditional_edges(
    "generic_sub_agent",
    tool_call_decision_edge,
    {
...
sub_agent_orchestration.add_edge("tool_result_synthesizer", "context_compressor")
